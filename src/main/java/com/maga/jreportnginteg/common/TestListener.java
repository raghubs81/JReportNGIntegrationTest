...
public class TestListener implements ITestListener
{
    ...
    {
        File fileSuc = new File(getResultName(result) + ".suc");
        try
        {
    ...
    {
        File fileDif = new File(getResultName(result) + ".skip.dif");
        try
        {
    ...
    {
        File fileDif = new File(getResultName(result) + ".dif");
        try
        {
    ...
    private String getResultName(ITestResult result)
    {
        ...
        String name = testClass.getName().replaceFirst("com.maga.jreportnginteg.", "");
